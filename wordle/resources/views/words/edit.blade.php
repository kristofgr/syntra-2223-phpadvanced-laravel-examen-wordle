              ...
              <div class="p-6 text-gray-900">
                ...
                <form method="post" action="{{ route('words.update', $word->id) }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="scheduled_at" name="scheduled_at" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $word->scheduled_at }}" required>
                    </div>
